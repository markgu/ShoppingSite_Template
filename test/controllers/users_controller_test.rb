...
=begin
  ...
  test "should update user" do
    patch :update, id: @user, user: { city: @user.city, firstName: @user.firstName, lastName: @user.lastName, password: @user.password, postcode: @user.postcode, state: @user.state, street: @user.street, userId: @user.userId }
    assert_redirected_to user_path(assigns(:user))
  end
