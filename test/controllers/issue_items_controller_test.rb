...
class IssueItemsControllerTest < ActionController::TestCase
  ...
  test "should create issue_item" do
    assert_difference('IssueItem.count') do
      post :create, issue_item: { comment: @issue_item.comment, finishDate: @issue_item.finishDate, startDate: @issue_item.startDate }
    end
  ...
  test "should update issue_item" do
    patch :update, id: @issue_item, issue_item: { comment: @issue_item.comment, finishDate: @issue_item.finishDate, startDate: @issue_item.startDate }
    assert_redirected_to issue_item_path(assigns(:issue_item))
  end
